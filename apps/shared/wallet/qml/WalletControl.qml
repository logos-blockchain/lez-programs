...
Item {
    ...
    readonly property var portfolioProvider: root.portfolio ? root.portfolio : root.wallet
    readonly property var networkProvider: root.network ? root.network : root.wallet
    readonly property string activeNetwork: root.networkProvider
        && root.networkProvider.walletNetwork !== undefined
        ? root.networkProvider.walletNetwork
        : root.networkProvider && root.networkProvider.activeNetwork
            ? root.networkProvider.activeNetwork : ""
    readonly property string networkStatus: root.networkProvider
        && root.networkProvider.networkStatus !== undefined
        ? root.networkProvider.networkStatus : ""
    readonly property string assetStatus: root.portfolioProvider
        && root.portfolioProvider.assetStatus !== undefined
        ? root.portfolioProvider.assetStatus : ""
    readonly property string assetError: root.portfolioProvider && root.portfolioProvider.assetError
        ? root.portfolioProvider.assetError : ""
    readonly property var walletAssets: root.portfolioProvider && root.portfolioProvider.assets
        ? root.portfolioProvider.assets : []
    ...
    Button {
        ...
        contentItem: RowLayout {
            ...
            Rectangle {
                ...
                radius: 4
                objectName: "walletNetworkStatusIndicator"
                color: !root.networkProvider || root.networkStatus.length === 0
                    || root.networkStatus === "ready"
                    ? "#22c55e"
                    : root.networkStatus === "loading" ? "#f59e0b" : "#ef4444"
            }
            Label {
        ...
        Component {
            ...
            ScrollView {
                ...
                ColumnLayout {
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                CopyButton {
                                    ...
                                    copyText: root.selectedDisplayAddress
                    ...
                    Label {
                        objectName: "walletAssetsLoadingLabel"
                        visible: root.portfolioProvider && root.assetStatus === "loading"
                    ...
                    Repeater {
                        ...
                        delegate: Rectangle {
                            ...
                            RowLayout {
                                ...
                                CopyButton {
                                    copyText: modelData.displayDefinitionId || modelData.definitionId
                                    copyLabel: qsTr("Copy token ID")
                                }
                            }
                        }
                    }
                    Label {
                        visible: (!root.walletAssets || root.walletAssets.length === 0)
                                 && (!root.portfolioProvider || root.assetStatus !== "loading")
                        text: root.assetError
                            ? qsTr("Assets unavailable: %1").arg(root.assetError)
                            : qsTr("No assets yet")
                        color: "#a1a1aa"
                        wrapMode: Text.Wrap
                    }
