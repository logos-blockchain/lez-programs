...
use crate::api::{
    ...
    WithdrawProtocolFeesPlanRequest,
};
...
#[unsafe(no_mangle)]
pub extern "C" fn amm_remove_liquidity_quote(request_json: *const c_char) -> *mut c_char {
    call::<RemoveLiquidityQuoteRequest>(request_json, api::remove_liquidity_quote)
}

#[unsafe(no_mangle)]
pub extern "C" fn amm_remove_liquidity_plan(request_json: *const c_char) -> *mut c_char {
...
#[unsafe(no_mangle)]
pub extern "C" fn amm_withdraw_protocol_fees_plan(request_json: *const c_char) -> *mut c_char {
    call::<WithdrawProtocolFeesPlanRequest>(request_json, api::withdraw_protocol_fees_plan)
}
