...
mod token {
    ...
    #[instruction]
    pub fn transfer(
        #[account(mut, signer)] sender: AccountWithMetadata,
    ...
    pub fn new_fungible_definition(
        ...
        #[account(init, signer)] holding_target_account: AccountWithMetadata,
        name: String,
        total_supply: u128,
    ...
    pub fn new_definition_with_metadata(
        #[account(init, signer)] definition_target_account: AccountWithMetadata,
        #[account(init, signer)] holding_target_account: AccountWithMetadata,
        #[account(init, signer)] metadata_target_account: AccountWithMetadata,
    ...
    pub fn initialize_account(
        ...
        #[account(init, signer)] account_to_initialize: AccountWithMetadata,
    ) -> SpelResult {
        Ok(spel_framework::SpelOutput::execute(
    ...
    #[instruction]
    pub fn burn(
        #[account(mut)] definition_account: AccountWithMetadata,
        #[account(mut, signer)] user_holding_account: AccountWithMetadata,
        amount_to_burn: u128,
    ) -> SpelResult {
        Ok(spel_framework::SpelOutput::execute(
    ...
    pub fn mint(
        ctx: ProgramContext,
        #[account(mut, signer)] definition_account: AccountWithMetadata,
        #[account(mut)] user_holding_account: AccountWithMetadata,
        amount_to_mint: u128,
    ) -> SpelResult {
        Ok(spel_framework::SpelOutput::execute(
    ...
    pub fn mint_with_authority(
        ...
        #[account(mut)] definition_account: AccountWithMetadata,
        #[account(mut)] user_holding_account: AccountWithMetadata,
        #[account(signer)] authority_account: AccountWithMetadata,
        amount_to_mint: u128,
    ) -> SpelResult {
        Ok(spel_framework::SpelOutput::execute(
    ...
    #[instruction]
    pub fn print_nft(
        #[account(mut, signer)] master_account: AccountWithMetadata,
        #[account(init, signer)] printed_account: AccountWithMetadata,
    ) -> SpelResult {
        Ok(spel_framework::SpelOutput::execute(
